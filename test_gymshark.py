...
brand_config = {
    'html': {
        'category_urls': ['https://www.gymshark.com/collections/all-products/mens'],
        'product_selector': "[data-testid*='productCard']:not([data-testid*='Wishlist'])",
        'product_selectors': {
            'external_id': "[data-testid*='productCard']",
            'product_id': "[data-testid*='productCard']",
        ...
        'use_browser': True,
        'prewarm': ['https://www.gymshark.com/', 'https://www.gymshark.com/collections/all-products/mens']
    }
}
...
try:
    ...
    print(f'Gymshark: Found {len(products)} products')
